...
import com.example.assignment2.viewmodels.SettingsViewModel;
...
public class MatchesFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        adapter = new ProductCardRecyclerViewAdapter(matchesList);
    ...
    public void getDistanceSetting() {
        ...
        final Observer<List<com.example.assignment2.entity.Settings>> getSettingsObserver = (new Observer<List<com.example.assignment2.entity.Settings>>() {
            @Override
            public void onChanged(List<com.example.assignment2.entity.Settings> settings) {
                ;
                if (settings == null || settings.size() <= 0) {
                    return;
                }

                com.example.assignment2.entity.Settings set = settings.get(settings.size() - 1);
